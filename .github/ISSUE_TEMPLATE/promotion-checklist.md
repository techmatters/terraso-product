...
about: A series of tasks to take to promote blogs, releases, events, etc.
title: 'Promotion: [Thing Promoted Goes Here]'
labels: Product
assignees: ''
type: Task
...
<!-- Remove and customize actions in this list as needed. --> 

- [ ] Publish blog, event, etc

## Social
- [ ] Terraso Mastodon (All Terraso, Terasso Story Maps, and LandPKS updates are published through Terraso Mastodon)
...
## Email
- [ ] Targeted outreach - close contacts who would benefit from knowledge of the post (list below)
